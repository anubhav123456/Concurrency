...
# Creating Threads in Java — Complete Notes
...
# Difference Between Runnable and Callable (Very Important 🔥)
...
| Result Handling    | ❌ No result    | ✅ Uses `Future`        |
...
> *“Callable is preferred over Runnable when we need a return value or exception handling. Runnable is simpler but limited.”*
...
* The native OS thread ❌ gets destroyed
* The call stack ❌ gets freed
* CPU resources ❌ get released
...
* ❌ Revive the old OS thread (not possible)
* ❌ Restore the old call stack (already destroyed)

👉 OS threads are dead after termination; they do not become zombies 😄

---

### ⭐ What is thread safety and how can it be achieved?

> *Thread safety refers to code that functions correctly during simultaneous execution by multiple threads. It can be achieved through: *
> Synchronization
> Immutable objects
