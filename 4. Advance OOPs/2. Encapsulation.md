...
## ✅ **1. Direct Data Access Bypasses Validation and Business Rules**
...
public class Main {
    public static void main(String[] args) {
        ...
        account.balance = -5000; // ❌ No validation: negative balance allowed!
...
## ✅ **2. Changing Fields Forces Modifications in Calling Code**
...
### 🔥 NOW imagine you change the class:
...
➡️ **This tight coupling makes your code fragile and hard to maintain.**

If you had used getters/setters, the internal fields could change without breaking code.


## ✅ **3. Without Constructors, Object Can Be Created in an Invalid / Half-Baked State**
...
public class Main {
    public static void main(String[] args) {
        User u = new User(); // ❌ No constructor
